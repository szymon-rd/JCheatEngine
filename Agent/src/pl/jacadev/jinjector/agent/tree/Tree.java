package pl.jacadev.jinjector.agent.tree;

import javafx.scene.control.TreeItem;
import javafx.scene.control.TreeView;
import pl.jacadev.jinjector.agent.tree.items.Item;
import pl.jacadev.jinjector.agent.tree.items.JINTreeCell;
import pl.jacadev.jinjector.agent.tree.items.PackageItem;
import pl.jacadev.jinjector.agent.tree.items.TextItem;
...
public class Tree {
    ...
    public static void createTree(TreeView<Item> tree) {
        tree.setCellFactory(itemTreeView -> new JINTreeCell());
